...
В качестве средства для хранения данных используется база данных SQLite3.
В корне репозитория находится файл базы данных
с созданными пустыми таблицами для хранения номеров телефонов и отзывов о них.
